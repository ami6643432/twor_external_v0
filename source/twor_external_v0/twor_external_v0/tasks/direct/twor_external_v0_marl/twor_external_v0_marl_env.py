...
from .twor_external_v0_marl_env_cfg import TworExternalV0MarlEnvCfg


class TworExternalV0MarlEnv(DirectMARLEnv):
    cfg: TworExternalV0MarlEnvCfg

    def __init__(self, cfg: TworExternalV0MarlEnvCfg, render_mode: str | None = None, **kwargs):
